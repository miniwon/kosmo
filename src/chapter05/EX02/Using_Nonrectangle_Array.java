...
public class Using_Nonrectangle_Array {
	...
	public static void main(String[] args) {
		...
		//방법1. 비정방형 배열 선언 => 방 크기를 생성 => 값 할당
		int[][] arr1 = new int[2][];		//행의 개수만 지정, 열의 개수는 나중에 지정
		arr1[0] = new int[2];				//0번째 행의 열의 개수 2개 지정
		arr1[0][0] = 1;
		arr1[0][1] = 2;
		
		arr1[1] = new int[3];				//1번째 행의 열의 개수 3개 지정
		arr1[1][0] = 3;
		arr1[1][1] = 4;
		arr1[1][2] = 5;
		...
		//방법2. 비정방형 배열 선언 시 값을 할당
		int[][] arr2 = new int[2][];		//비정방형 배열 선언: 행의 개수만 선언, 열의 개수는 선언하지 않음
		arr2[0] = new int[] {1,2};			//0번째 행의 값을 바로 할당
		...
		//방법4. 비정방형 배열 선언 시 값을 할당 (선언과 초기화 분리 불가능)
		int[][] arr5 = {{1,2},{3,4,5}};
