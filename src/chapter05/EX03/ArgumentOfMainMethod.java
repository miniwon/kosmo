...
public class ArgumentOfMainMethod {
	...
	public static void main(String[] args) {
		//main Method의 입력매개변수 전달하기, 메소드(객체지향언어) = 함수
		//		- 메소드(함수)의 형식: 리턴타입	메소드명	(입력매개변수)			{실행부}
		//							void	main	(String[] args) 	{실행부}

		//메인 메소드의 입력 매개 변수 args[i] 값을 받아서 각 변수에 할당
		...
		//숫자 형식으로 되어 있는 String => 정수, 실수형으로 변환
		...
		System.out.println(d);				//d: 정수형 3
		System.out.println(e);				//e: 실수형 5.8
