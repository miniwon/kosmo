...
// super()		: 상속 관계, 부모 클래스의 생성자 호출, 생성자 내부에서 첫 라인에 위치
//		자식 클래스는 생성자 내부에 첫 this(), super() 중에 반드시 하나는 와야 한다
//		- 생략 시 super(), 부모의 기본 생성자가 자동으로 입력(생략)된다
...
class A {
	...
	A(int a){
		System.out.println("A의 입력매개변수 1개 생성자 - A(10)");
	}
}
class B extends A {
	B() {
	...
	B(int a) {		// super(), 부모의 기본 생성자 호출이 생략되어 있다
		System.out.println("B의 입력매개변수 1개 생성자 - B(10)");
	}
}
